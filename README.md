...
|VDss_Lombardo| VDss (Volumn of Distribution at steady state), Lombardo et al.
...
Task Description: Regression. Given a drug SMILES string, predict the volume of distributon.|Regression. Given a drug SMILES string, predict the volume of distributon.|1,130 drugs
